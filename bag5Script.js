...
(function () {
    ...
    items.forEach((item) => {
      ...
      // [수정 포인트] 이번 Bag5는 data-normal을 사용합니다.
      const baseSrc = img.getAttribute("data-normal") || img.src;
      ...
      function closeAll() {
        items.forEach((i) => {
          ...
          const iBase = iImg.getAttribute("data-normal") || iImg.src;
          iImg.src = iBase;
        });
      }
